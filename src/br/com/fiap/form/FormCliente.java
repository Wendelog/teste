...
public class FormCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtNascimento.setToolTipText("Data no formato dd/mm/aaaa");
        ...
        if (tabela.getColumnModel().getColumnCount() > 0) {
            tabela.getColumnModel().getColumn(0).setPreferredWidth(14);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(10, 10, 10)
                .addComponent(btnEscolherFoto, javax.swing.GroupLayout.PREFERRED_SIZE, 213, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(layout.createSequentialGroup()
                .addGap(23, 23, 23)
    ...
    private void btnEscolherFotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEscolherFotoActionPerformed
        JFileChooser fileChooser = new JFileChooser("C:\\Users\\logonpf\\Desktop\\ProjetoBancoDeDados2SIA\\fotos");
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
            ...
            dataFormatada = new SimpleDateFormat("dd/MM/yyyy");
            Date dtNascimento = new Date(dataFormatada.parse(nascimento).getTime());
            Cliente cliente = new Cliente(cpf, nome, endereco, dtNascimento, fone, caminho);
            ClienteDAO dao = new ClienteDAO();
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if (cpf.equals("")) {
            ...
            ClienteDAO dao = new ClienteDAO();
            Cliente cliente = dao.pesquisarCPF(cpf);
            if (cliente == null) {
